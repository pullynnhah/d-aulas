...
export default function App() {
  ...
  return (
    <>
      {exibirModalSucesso && (
        <Modal title="Mensagem enviada com sucesso" func={setExibirModalSucesso}>
          Obrigado por entrar em contato {nome}! Sua reclamação será <strong>sim</strong> avaliada e
          considerada por nossa equipe!
        </Modal>
      )}

      {exibirModalErro && (
        <Modal title="Erro" func={setExibirModalErro}>
          Por favor, insira os dados <strong>nome</strong> e <strong>reclamação</strong>{" "}
          corretamente!
        </Modal>
      )}
